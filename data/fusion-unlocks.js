...
const FUSION_UNLOCKS = {
  ...
  gatedPersonas: {
    ...
    Surt: { type: 'manual', key: 'junpei-baseball-glove', label: "Junpei Linked Episode 5: Baseball Glove" },
    Horus: { type: 'manual', key: 'akihiko-hand-wraps', label: "Akihiko Linked Episode 5: Hand Wraps" },
    Byakko: { type: 'manual', key: 'koromaru-collar', label: "Koromaru Linked Episode 5: Koromaru's Collar" },
    Michael: { type: 'manual', key: 'ken-silver-key', label: "Ken Linked Episode 5: Silver Key" },
    'Hell Biker': { type: 'manual', key: 'shinjiro-incomplete-form', label: 'Shinjiro Linked Episode 5: Incomplete Form' },
    Saturnus: { type: 'manual', key: 'ryoji-music-box', label: 'Ryoji Linked Episode 5: Music Box' },
