...
const ELIZABETH_REQUEST_ROWS = [
  ...
  [7, "Bring me a Juzumaru", "Available 5/10, no Deadline", "Makouha (Skill Card)", "Juzumaru can be found on Tartarus Floor 36 in the treasure chest after defeating the boss. Show the sword to Elizabeth to complete the request.", "Complete \"Quest 2 - Retrieve the first Old Document.\""],
  ...
  [9, "I'd like to try all kinds of drinks", "Available 5/10, No Deadline", "Media (Skill Card)", "You will need to collect 12 different types of drinks from vending machines and bring them to Elizabeth. Vending Machine 1: Iwatodai Strip Mall - 3F", "Complete \"Quest 1 - Bring me a Muscle Drink.\""],
  ...
  [11, "Please prevail in the Big Eater Challenge", "Available 5/10, No Deadline", "Twilight Fragment x3", "Wilduck Burgers will host the Big Eater Challenge on weekends. Pick: Look away from the burgers, eat without stopping, then imagine something sour.", "Complete \"Quest 9 - I'd like to try all kinds of drinks.\""],
